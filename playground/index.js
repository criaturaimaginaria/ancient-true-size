...
const layers = {
  ...
  Numidia:Numidia,
  SanMarino:SanMarino,
  papalStates:papalStates,
  papalStates2:papalStates2,
  ...
  Corinth: Corinth,
  Argos:Argos,
  ArcadianLeague:ArcadianLeague,
  Elis:Elis,
  Patras:Patras,
  Thebas:Thebas,
  Aegina:Aegina,
  achaeanLeague:achaeanLeague,
  achaeanLeague2:achaeanLeague2,
